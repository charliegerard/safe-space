...
describe('conv_util computeConv2DInfo roundingMode', () => {
    ...
    it('should fail computing the output dimension of Conv Layer', () => {
        expect(() => conv_util.computeConv2DInfo(inShape, [fSize, fSize, inChannels, chMul], stride, dilation, pad))
            .toThrowError();
    });
...
describe('conv_util computePoolInfo roundingMode', () => {
    ...
    it('should fail computing the output dimension of Pool Layer', () => {
        expect(() => conv_util.computePool2DInfo(inShape, [fSize, fSize], stride, dilation, pad))
            .toThrowError();
    });
